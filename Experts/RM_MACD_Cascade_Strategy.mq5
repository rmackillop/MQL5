...
void OnTick() 
{
   ...
   {
      int openOrders = SymbolOpenOrders(_Symbol);
      
      ST_StopLoss_TakeProfit res = Cascade_trading(_Symbol,LotSize,IsBuy,Ask,Bid,TakeProfit,StopLoss,StopLossPoints,MinimumStopLossPoints,R2R,true,openOrders);
